...
> The backend should be running while executing these tests.

1. Make sure your app is not running, otherwise it will be a port conflict
(this way of executing the e2e tests launch the app temporally).

2. Place your E2E-Tests into the folder ```test/e2e/src```

3. Run the tests by invoking ()
